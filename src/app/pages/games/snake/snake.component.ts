...
export class SnakeComponent {
  ...
  handleKeyboardEvents(e: KeyboardEvent) {
    ...
    if (this.directionLeft && this.snake.direction !== CONTROLS.RIGHT) {
      this.tempDirection = CONTROLS.LEFT;
      this.directionLeft = false;
    } else if (this.directionUp && this.snake.direction !== CONTROLS.DOWN) {
      this.tempDirection = CONTROLS.UP;
      this.directionUp = false;
    } else if (this.directionDown && this.snake.direction !== CONTROLS.UP) {
      this.tempDirection = CONTROLS.DOWN;
      this.directionDown = false;
    } else if (this.directionRight && this.snake.direction !== CONTROLS.LEFT) {
      this.tempDirection = CONTROLS.RIGHT;
      this.directionRight = false;
    }
  }
